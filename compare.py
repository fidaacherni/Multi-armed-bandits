...
if __name__ == "__main__":
    ...
    # Best eps-greedy 
    eps_greedy_best_eps = 0.3          # Modify this param
    ...
    # Best UCB
    ucb_best_c = 3                    # Modify this param
    ...
    # Best Boltzmann
    boltzmann_best_tau = 0.2         # Modify this param
    ...
    gradient_bandit_best_alpha = 1.55                            # Modify this param
    ...
    save_results_plots(results_list, plot_title="Ultimate Showdown: Tuning Parameters and Comparing Methods",
                       results_folder='results', pdf_name='final_comparison2.pdf')
